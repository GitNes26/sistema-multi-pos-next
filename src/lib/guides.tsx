...
const productGuide: GuideDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: (
        <div className="space-y-2">
          <p>Este es el formulario real. La guía permanecerá contigo mientras lo llenas:</p>
          ...
          <p className="pt-1 font-medium">Primero decide qué clase de producto vas a vender.</p>
        </div>
      ),
    },
    {
      ...
      body: (
        <p>
          Usa <strong>Estándar</strong> para artículos y variantes; <strong>Granel</strong>
          para peso, volumen o longitud; y <strong>Personalizado</strong> para productos
          construidos con tamaños, ingredientes y extras. Los siguientes campos se adaptan
          a tu elección.
        </p>
      ),
    },
    {
      ...
      body: <p>Escribe el nombre que reconocerán tanto el cajero como el cliente. El sistema marcará aquí cualquier error antes de guardar.</p>,
    },
    {
      route: "/admin/products",
      ...
      body: (
        <p>
          La categoría organiza el POS y el portal. Puedes elegir una existente o crearla
          desde este selector. El mismo patrón se aplica a unidades y otros selectores:
          crea el catálogo relacionado sin perder lo que ya capturaste.
        </p>
      ),
    },
    {
      ...
      body: <p>Confirma el impuesto aplicable. Después completa imagen, precio, costo, SKU, código de barras y los campos propios del tipo elegido.</p>,
    },
    {
      route: "/admin/products",
      selector: "[data-guide='crud-submit']",
      title: "Crea el producto",
      body: <p>Presiona <strong>«Crear producto»</strong>. Si falta algo, el formulario enfocará el primer campo inválido y mostrará todos los errores junto a sus campos. Continúa cuando el diálogo se cierre.</p>,
    },
    {
      route: "/admin/products",
    ...
    },
    {
      ...
      body: <p>Si tu producto usa tallas, sabores o presentaciones, abre <strong>«Variantes»</strong> en su fila y termina SKU, código, precio, costo e imagen. Si no usa variantes, continúa al inventario.</p>,
    },
    {
    ...
    },
    {
      ...
      body: <p>Cuando tengas más de una sucursal o CEDIS, usa <strong>«Transferir»</strong>. Elige origen, destino y cantidad; el sistema valida disponibilidad y registra ambos movimientos.</p>,
    },
    {
...
const combosGuide: GuideDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: <p>Define nombre, vigencia y precio; después agrega los productos y cantidades. El resumen compara el precio individual con el precio especial antes de guardar.</p>,
    },
    {
      title: "¡Listo!",
      body: (
...
const inventoryGuide: GuideDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: <p>Define el nivel que dispara una alerta de reabastecimiento para esta variante y ubicación.</p>,
    },
    {
      route: "/admin/inventory",
      selector: "[data-guide='inv-transfer']",
      title: "Transfiere existencias",
      body: <p>Mueve unidades entre sucursales o CEDIS. El traslado conserva el historial de origen y destino.</p>,
    },
    {
      title: "¡Listo!",
      body: (
...
const tablesGuide: GuideDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: <p>Configura anticipación, duración, tolerancia y capacidad. Estas reglas se comparten con el panel, el portal y la reservación pública.</p>,
    },
    {
      route: "/admin/tables",
      selector: "[data-guide='tables-reservation']",
      title: "Prueba una reservación",
      body: <p>Abre el flujo real de reservación, elige fecha, turno, cantidad de personas y mesa. Así compruebas el recorrido antes de compartirlo.</p>,
    },
    {
      title: "¡Listo!",
      body: (
...
const agendaGuide: GuideDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: <p>Abre el formulario real y elige cliente, servicio, miembro del equipo, fecha y hora. Si aún no asignaste servicios, usa primero la pestaña <strong>«Personal y servicios»</strong>.</p>,
      advanceOnClick: true,
    },
    {
      route: "/agenda",
      ...
      body: <p>Selecciona cliente, personal y servicio. La duración y la disponibilidad se validan contra el horario del empleado; agrega una nota si el equipo necesita preparación especial.</p>,
    },
    {
      title: "¡Listo!",
      body: (
...
const reservationGuide: GuideDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: <p>Selecciona o crea el cliente, indica entrega y devolución, añade artículos y cantidades. El sistema evita reservar más unidades de las disponibles.</p>,
    },
    {
      title: "¡Listo!",
      body: (
...
const deliveryGuide: GuideDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: <p>Guarda los cambios y prueba ambos métodos desde el portal. Si activas pago en línea, continúa después en <strong>Ajustes → Pagos</strong>.</p>,
    },
    {
      title: "¡Listo!",
      body: (
...
const promotionGuide: GuideDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: <p>Guarda la promoción. Si está activa, el sistema prepara también su publicación. Verifica después el resultado en POS y portal.</p>,
    },
    {
      title: "¡Listo!",
      body: (
...
const portalGuide: GuideDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: (
        <p>
          Captura nombre, correo y los datos necesarios. Guarda la cuenta y conserva
          sus credenciales de prueba para abrir el portal en una sesión separada.
        </p>
      ),
    },
    {
      ...
      body: (
        <p>
          Abre el portal en otra pestaña o en una ventana privada, entra con el cliente
          de prueba y haz un pedido. Después vuelve a <strong>Operación → Pedidos</strong>
    ...
    },
    {
      ...
      actions: [
        { label: "Abrir portal en otra pestaña", href: "/portal/auth/login", primary: true, newTab: true },
  ...
  steps: [
    {
      ...
      body: <p>Abre el mapa y elige la mesa antes de agregar productos. El ticket y la comanda quedarán ligados a esa mesa.</p>,
      advanceOnClick: true,
    },
    {
      route: "/pos",
      ...
      body: <p>Las mesas libres, ocupadas y reservadas se distinguen aquí. Elige una libre para continuar el recorrido en la caja.</p>,
    },
    {
      route: "/pos",
      selector: "[data-guide='pos-send-kitchen']",
      title: "Envía la comanda",
      body: <p>Agrega productos al ticket y usa <strong>«Enviar a cocina»</strong>. Solo se envían las líneas nuevas; el estado se actualiza en vivo.</p>,
    },
    {
      route: "/kds",
      selector: "[data-guide='kds-screen']",
      title: "Cocina continúa el pedido",
      body: <p>En KDS el equipo marca la comanda como preparando y luego lista. La caja ve esos cambios sin recargar.</p>,
    },
    {
      route: "/pos",
      selector: "[data-guide='pos-checkout']",
      title: "Cobra y libera",
      body: <p>Cuando el pedido esté listo, vuelve al POS, abre la mesa y cobra. Al completar el pago, la mesa queda libre para el siguiente cliente.</p>,
    },
    {
      title: "Flujo de mesa terminado",
      body: <p>Ya recorriste la operación completa: mesa, comanda, cocina y cobro.</p>,
      actions: [
