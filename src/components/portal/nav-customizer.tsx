...
const DEFAULT_ORDER: NavItemIdIncludingCombos[] = [
  "home",
  "store",
  "reservations",
  "orders",
...
export function NavCustomizer() {
  ...
  const removeItem = (id: NavItemIdIncludingCombos) => {
      ...
      <div className="space-y-1.5">
        <AnimatePresence>
          {orderedItems.map((item, idx) => {
            ...
            const isHidden = HIDDEN_FROM_BAR.includes(item.id);
            return (
              <motion.div
                key={item.id}
                layout
              ...
              >
                ...
                >
                  ...
                  >
                    <GripVertical
                      className={cn(
                        "size-4 shrink-0 cursor-grab text-muted-foreground/50",
