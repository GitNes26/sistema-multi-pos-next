  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="sm:max-w-md">
        ...
        {customerId && (
          <Button variant="ghost" size="sm" onClick={() => setCustomer(null)} className="text-destructive">
            <Trash2 className="size-4" /> Quitar cliente actual
          </Button>
        )}
        ...
        <div className="scrollbar-none max-h-72 space-y-1.5 overflow-y-auto">
          {filtered.length === 0 ? (
